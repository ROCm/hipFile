...
toRocFileSizeTConfigParameter(hipFileSizeTConfigParameter_t param)
{
    switch (param) {
        case hipFileParamProfileStats:
            return rocFileParamProfileStats;
        ...
        case hipFileParamExecutionMinIOThresholdSizeKB:
            return rocFileParamExecutionMinIOThresholdSizeKB;
        case hipFileParamExecutionMaxRequestParallelism:
            return rocFileParamExecutionMaxRequestParallelism;
        case hipFileParamPropertiesMaxDirectIOSizeKB:
            return rocFileParamPropertiesMaxDirectIOSizeKB;
        case hipFileParamPropertiesMaxDeviceCacheSizeKB:
            return rocFileParamPropertiesMaxDeviceCacheSizeKB;
        case hipFileParamPropertiesPerBufferCacheSizeKB:
            return rocFileParamPropertiesPerBufferCacheSizeKB;
        case hipFileParamPropertiesMaxDevicePinnedMemSizeKB:
            return rocFileParamPropertiesMaxDevicePinnedMemSizeKB;
        case hipFileParamPropertiesIOBatchsize:
            return rocFileParamPropertiesIOBatchsize;
        case hipFileParamPollthresholdSizeKB:
            return rocFileParamPollthresholdSizeKB;
        case hipFileParamPropertiesBatchIOTimeoutMs:
            return rocFileParamPropertiesBatchIOTimeoutMs;
        default:
...
toRocFileStringConfigParameter(hipFileStringConfigParameter_t param)
{
    switch (param) {
        case hipFileParamLoggingLevel:
            return rocFileParamLoggingLevel;
        case hipFileParamEnvLogfilePath:
            return rocFileParamEnvLogfilePath;
        case hipFileParamLogDir:
            return rocFileParamLogDir;
        default:
